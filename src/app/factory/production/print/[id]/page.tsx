        ...
        <div className="border-4 border-gray-800 p-4 mb-6">
          <div className="flex justify-between items-start">
            ...
            <div className="w-32 flex flex-col items-center border-r-2 pr-4 ml-4">
              <QRCodeSVG value={typeof window !== 'undefined' ? `${window.location.origin}/factory/production/print/${order.id}` : order.id} size={100} />
        ...
        <div className="flex gap-6 flex-1">
          ...
          <div className="w-2/3 grid grid-cols-2 gap-2 h-fit">
            ...
            <div className="border border-gray-400 p-2 flex flex-col col-span-1">
              ...
              <p className="text-sm min-h-[30px] whitespace-pre-wrap">{order.pairingNotes || '---'}</p>
            </div>
